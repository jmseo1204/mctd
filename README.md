...
Download the models from this [link](https://drive.google.com/drive/folders/1r8xTxvHS0HIE1jbskAVxr9jdM6UiQU6P?usp=share_link).
...
- Open `insert_cube_validation_jobs.py`.
...
```bash
python insert_cube_validation_jobs.py
```
